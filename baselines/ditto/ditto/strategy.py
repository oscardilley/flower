...
class Ditto(fl.server.strategy.strategy.Strategy):
    """
    ...
    def configure_fit(
        ...
        # Ditto specific parameters are appended 
        config['lambda'] = self.ditto_lambda
        config['eta'] = self.ditto_eta
        config['s'] = self.ditto_s
